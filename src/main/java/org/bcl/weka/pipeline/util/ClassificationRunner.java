...
{	
	...
	public ClassificationRunner(SortFile[] inputfiles, File outputdirectory, String removeop) throws Exception
	{
		...
		for(int x = 0; x < inputfiles.length; x++)
		{
			...
			for (int i = classifiers.size() - 3; i < classifiers.size(); i++) {
